...
import { getClassName, getSafeText, isElementNode, isSensitiveElement, isTag, isTextNode, shouldCaptureDomEvent, shouldCaptureElement, shouldCaptureValue, autocaptureCompatibleElements, isAngularStyleAttr, isDocumentFragment, getDirectAndNestedSpanText, getElementsChainString, } from './autocapture-utils';
    ...
    _captureEvent: function (e, instance, eventName) {
        ...
        if (target && shouldCaptureDomEvent(target, e, this.config)) {
            ...
            var props = _extend(this._getDefaultProperties(e.type), instance.elementsChainAsString
                ...
                }, ((_b = elementsJson_1[0]) === null || _b === void 0 ? void 0 : _b['$el_text']) ? { $el_text: (_c = elementsJson_1[0]) === null || _c === void 0 ? void 0 : _c['$el_text'] } : {}, this._getCustomProperties(targetElementList), autocaptureAugmentProperties_1);
