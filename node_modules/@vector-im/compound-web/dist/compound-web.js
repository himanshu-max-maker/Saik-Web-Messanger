...
import React__default, { forwardRef, useCallback, useEffect, Children, createContext, useMemo, useContext, useReducer, isValidElement, createElement, cloneElement, Fragment } from "react";
import GraphemeSplitter from "graphemer";
import { renderToStaticMarkup } from "react-dom/server";
import { Root as Root$1, Trigger, Portal, Content, DropdownMenuItem } from "@radix-ui/react-dropdown-menu";
import { Drawer } from "vaul";
import { Control, Root as Root$3, Field as Field$1, Label as Label$1, Message, Submit as Submit$1, ValidityState } from "@radix-ui/react-form";
import { Message as Message2, ValidityState as ValidityState2 } from "@radix-ui/react-form";
import { Provider, Root as Root$2, Trigger as Trigger$1, Portal as Portal$1, Content as Content$1, Arrow } from "@radix-ui/react-tooltip";
import "react-dom";
const SvgCheckCircle = (props) => /* @__PURE__ */ jsx("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "cpd-icon", ...props, children: /* @__PURE__ */ jsx("path", { d: "M10.6 13.8L8.45 11.65C8.26667 11.4667 8.03333 11.375 7.75 11.375C7.46667 11.375 7.23333 11.4667 7.05 11.65C6.86667 11.8333 6.775 12.0667 6.775 12.35C6.775 12.6333 6.86667 12.8667 7.05 13.05L9.9 15.9C10.1 16.1 10.3333 16.2 10.6 16.2C10.8667 16.2 11.1 16.1 11.3 15.9L16.95 10.25C17.1333 10.0667 17.225 9.83333 17.225 9.55C17.225 9.26667 17.1333 9.03333 16.95 8.85C16.7667 8.66667 16.5333 8.575 16.25 8.575C15.9667 8.575 15.7333 8.66667 15.55 8.85L10.6 13.8ZM12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22ZM12 20C14.2333 20 16.125 19.225 17.675 17.675C19.225 16.125 20 14.2333 20 12C20 9.76667 19.225 7.875 17.675 6.325C16.125 4.775 14.2333 4 12 4C9.76667 4 7.875 4.775 6.325 6.325C4.775 7.875 4 9.76667 4 12C4 14.2333 4.775 16.125 6.325 17.675C7.875 19.225 9.76667 20 12 20Z", fill: "currentColor" }) });
const SvgError = (props) => /* @__PURE__ */ jsx("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "cpd-icon", ...props, children: /* @__PURE__ */ jsx("path", { d: "M12 17C12.2833 17 12.5208 16.9042 12.7125 16.7125C12.9042 16.5208 13 16.2833 13 16C13 15.7167 12.9042 15.4792 12.7125 15.2875C12.5208 15.0958 12.2833 15 12 15C11.7167 15 11.4792 15.0958 11.2875 15.2875C11.0958 15.4792 11 15.7167 11 16C11 16.2833 11.0958 16.5208 11.2875 16.7125C11.4792 16.9042 11.7167 17 12 17ZM12 13C12.2833 13 12.5208 12.9042 12.7125 12.7125C12.9042 12.5208 13 12.2833 13 12V8C13 7.71667 12.9042 7.47917 12.7125 7.2875C12.5208 7.09583 12.2833 7 12 7C11.7167 7 11.4792 7.09583 11.2875 7.2875C11.0958 7.47917 11 7.71667 11 8V12C11 12.2833 11.0958 12.5208 11.2875 12.7125C11.4792 12.9042 11.7167 13 12 13ZM12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22Z", fill: "currentColor" }) });
const SvgInfo = (props) => /* @__PURE__ */ jsxs("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "cpd-icon", ...props, children: [
  /* @__PURE__ */ jsx("path", { d: "M11.2875 7.2875C11.4792 7.09583 11.7167 7 12 7C12.2833 7 12.5208 7.09583 12.7125 7.2875C12.9042 7.47917 13 7.71667 13 8C13 8.28333 12.9042 8.52083 12.7125 8.7125C12.5208 8.90417 12.2833 9 12 9C11.7167 9 11.4792 8.90417 11.2875 8.7125C11.0958 8.52083 11 8.28333 11 8C11 7.71667 11.0958 7.47917 11.2875 7.2875Z", fill: "currentColor" }),
  /* @__PURE__ */ jsx("path", { d: "M11.2875 11.2875C11.4792 11.0958 11.7167 11 12 11C12.2833 11 12.5208 11.0958 12.7125 11.2875C12.9042 11.4792 13 11.7167 13 12V16C13 16.2833 12.9042 16.5208 12.7125 16.7125C12.5208 16.9042 12.2833 17 12 17C11.7167 17 11.4792 16.9042 11.2875 16.7125C11.0958 16.5208 11 16.2833 11 16V12C11 11.7167 11.0958 11.4792 11.2875 11.2875Z", fill: "currentColor" }),
  /* @__PURE__ */ jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z", fill: "currentColor" })
] });
const SvgClose = (props) => /* @__PURE__ */ jsx("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "cpd-icon", ...props, children: /* @__PURE__ */ jsx("path", { d: "M6.29289 6.29289C6.68342 5.90237 7.31658 5.90237 7.70711 6.29289L12 10.5858L16.2929 6.29289C16.6834 5.90237 17.3166 5.90237 17.7071 6.29289C18.0976 6.68342 18.0976 7.31658 17.7071 7.70711L13.4142 12L17.7071 16.2929C18.0976 16.6834 18.0976 17.3166 17.7071 17.7071C17.3166 18.0976 16.6834 18.0976 16.2929 17.7071L12 13.4142L7.70711 17.7071C7.31658 18.0976 6.68342 18.0976 6.29289 17.7071C5.90237 17.3166 5.90237 16.6834 6.29289 16.2929L10.5858 12L6.29289 7.70711C5.90237 7.31658 5.90237 6.68342 6.29289 6.29289Z", fill: "currentColor" }) });
...
const IconButton = forwardRef(function IconButton2({ children, className, indicator, size = "32px", style, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsx(
    UnstyledButton,
    {
      ...
      children: React__default.Children.only(children)
    }
  );
});
const Alert = ({
  ...
  const renderIcon = useCallback(
    (props2) => {
      switch (type) {
        case "critical":
          return /* @__PURE__ */ jsx(SvgError, { ...props2 });
        case "info":
          return /* @__PURE__ */ jsx(SvgInfo, { ...props2 });
        case "success":
          return /* @__PURE__ */ jsx(SvgCheckCircle, { ...props2 });
      }
    },
    [type]
  );
  return /* @__PURE__ */ jsxs("div", { ...props, className: classes, "data-type": type, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: styles$j.content, children: [
      /* @__PURE__ */ jsxs("div", { className: styles$j["text-content"], children: [
        /* @__PURE__ */ jsx(Text, { size: "md", weight: "semibold", children: title2 }),
        /* @__PURE__ */ jsx(Text, { size: "sm", weight: "regular", children })
      ] }),
      actions2 && /* @__PURE__ */ jsx("div", { className: styles$j.actions, children: actions2 })
    ] }),
...
const Avatar = forwardRef(function Avatar2({
  ...
  return React__default.createElement(
    ...
    /* @__PURE__ */ jsx(React__default.Fragment, { children: !src ? getInitialLetter(name) : /* @__PURE__ */ jsx(
      "img",
      {
        loading: "lazy",
        alt: "",
...
const SvgAvatarClipmask = (props) => /* @__PURE__ */ jsx("svg", { width: "1em", height: "1em", className: "cpd-icon", ...props, children: /* @__PURE__ */ jsx("clipPath", { id: "cpdAvatarClip", clipPathUnits: "objectBoundingBox", children: /* @__PURE__ */ jsx("path", { d: "         M 0.875 0.16666         A 0.5 0.5 0 1 0 0.875 0.83333         Q 0.65 0.5 0.875 0.16666         Z      " }) }) });
...
const AvatarStack = ({ children, className }) => {
  useEffect(() => {
    if (AvatarStackUsageCount === 0) {
      const svgMask = renderToStaticMarkup(
        /* @__PURE__ */ jsx(SvgAvatarClipmask, { id: AVATAR_MASK_ID, className: styles$f["clip-path"] })
      );
  ...
  return /* @__PURE__ */ jsx("div", { className: classNames(styles$f["stacked-avatars"], className), children });
};
...
const Glass = forwardRef(
  ({ children, className, ...rest }, ref) => /* @__PURE__ */ jsx("div", { ref, className: classNames(className, styles$d.glass), ...rest, children: Children.only(children) })
);
...
const react18UseId = React["useId".toString()];
const getUniqueId = (() => {
  let index2 = 1;
  return () => `:r${index2++}:`;
})();
...
const DrawerMenu = forwardRef(
  ({ title: title2, children, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
...
const Menu = ({
  ...
  return drawer2 ? /* @__PURE__ */ jsxs(Drawer.Root, { open, onOpenChange, children: [
    ...
    /* @__PURE__ */ jsxs(Drawer.Portal, { children: [
      ...
      /* @__PURE__ */ jsx(Drawer.Content, { asChild: true, children: /* @__PURE__ */ jsx(DrawerMenu, { title: title2, children }) })
    ] })
  ] }) : /* @__PURE__ */ jsxs(Root$1, { open, onOpenChange, children: [
    /* @__PURE__ */ jsx(Trigger, { asChild: true, children: trigger }),
    /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsx(Content, { asChild: true, side, align, sideOffset: 8, children: /* @__PURE__ */ jsx(FloatingMenu, { title: title2, children }) }) })
  ] });
};
...
const SvgChevronRight = (props) => /* @__PURE__ */ jsx("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "cpd-icon", ...props, children: /* @__PURE__ */ jsx("path", { d: "M8.70005 17.3C8.51672 17.1167 8.42505 16.8834 8.42505 16.6C8.42505 16.3167 8.51672 16.0834 8.70005 15.9L12.6 12L8.70005 8.10005C8.51672 7.91672 8.42505 7.68338 8.42505 7.40005C8.42505 7.11672 8.51672 6.88338 8.70005 6.70005C8.88338 6.51672 9.11672 6.42505 9.40005 6.42505C9.68338 6.42505 9.91672 6.51672 10.1 6.70005L14.7 11.3C14.8 11.4 14.8709 11.5084 14.9125 11.625C14.9542 11.7417 14.975 11.8667 14.975 12C14.975 12.1334 14.9542 12.2584 14.9125 12.375C14.8709 12.4917 14.8 12.6 14.7 12.7L10.1 17.3C9.91672 17.4834 9.68338 17.575 9.40005 17.575C9.11672 17.575 8.88338 17.4834 8.70005 17.3Z", fill: "currentColor" }) });
const MenuItem = ({
  as,
  className,
  Icon,
  ...
  const content2 = /* @__PURE__ */ jsxs(
    Component,
    {
      ...
      disabled: disabled2,
      children: [
        /* @__PURE__ */ jsx(Icon, { width: 24, height: 24, className: styles$a.icon, "aria-hidden": true }),
        label2 !== null && /* @__PURE__ */ jsx(Text, { className: styles$a.label, size: "md", weight: "medium", as: "span", children: label2 }),
  ...
  return context?.MenuItemWrapper == null || onSelect === null ? content2 : /* @__PURE__ */ jsx(context.MenuItemWrapper, { onSelect, children: content2 });
};
...
const Tooltip = ({
  ...
  return /* @__PURE__ */ jsx(Provider, { children: /* @__PURE__ */ jsxs(Root$2, { open, delayDuration: isTriggerInteractive ? 300 : 0, children: [
    /* @__PURE__ */ jsx(Trigger$1, { asChild: true, children: isTriggerInteractive ? children : /* @__PURE__ */ jsx("span", { tabIndex: nonInteractiveTriggerTabIndex, children }) }),
    /* @__PURE__ */ jsx(Portal$1, { children: /* @__PURE__ */ jsxs(
      Content$1,
      {
        side,
        align,
        ...
        children: [
          label2,
          (caption2 || shortcut) && /* @__PURE__ */ jsx("span", { className: classNames(styles$6.caption, "cpd-theme-dark"), children: caption2 ?? shortcut }),
          /* @__PURE__ */ jsx(Arrow, { width: 10, height: 6, className: styles$6.arrow })
        ]
      }
    ) })
  ] }) });
...
const ActionInput = forwardRef(
  function ActionControl2({ Icon, className, actionLabel, onActionClick, ...props }, ref) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: classes, id, children: [
      /* @__PURE__ */ jsx(TextInput, { ref, ...props, className: styles$8.control }),
...
const PasswordInput = forwardRef(function PasswordControl2(props, ref) {
  const [{ icon: icon2, label: label2, type }, togglePasswordVisibility] = useReducer(
...
const MFAInput = forwardRef(function MFAInput2({ className, length = 6, ...props }, ref) {
  ...
  const [currentLength, setCurrentLength] = React__default.useState(0);
  ...
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    ...
    Array.from(Array(length).keys()).map((index2) => /* @__PURE__ */ jsx(
      Digit,
      {
...
const CheckboxInput = forwardRef(
  function Checkbox({ className, ...props }, ref) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: classes, children: [
      /* @__PURE__ */ jsx("input", { ref, className: styles$4.input, ...props, type: "checkbox" }),
      /* @__PURE__ */ jsx("div", { className: styles$4.ui, children: /* @__PURE__ */ jsx(SvgCheck, { "aria-hidden": true }) })
    ] });
  }
);
...
const RadioInput = forwardRef(function Radio({ className, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    /* @__PURE__ */ jsx("input", { ref, ...props, className: styles$3.input, type: "radio" }),
    /* @__PURE__ */ jsx("div", { className: styles$3.ui })
  ] });
});
...
const ToggleInput = forwardRef(function Toggle({ className, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    /* @__PURE__ */ jsx("input", { ref, className: styles$2.input, ...props, type: "checkbox" }),
    /* @__PURE__ */ jsx("div", { className: styles$2.ui })
  ] });
});
...
const Root = forwardRef(
  function Root2({ children, ...props }, ref) {
    ...
    return /* @__PURE__ */ jsx(Root$3, { ref, ...props, className: classes, children });
  }
);
const Field = forwardRef(
  function Field2({ children, ...props }, ref) {
    const classes = classNames(styles$1.field, props.className);
    return /* @__PURE__ */ jsx(Field$1, { ref, ...props, className: classes, children });
  }
);
const InlineField = forwardRef(
  function InlineField2({ className, control: control2, children, ...props }, ref) {
    ...
    return /* @__PURE__ */ jsxs(Field$1, { ref, ...props, className: classes, children: [
      /* @__PURE__ */ jsx("div", { className: styles$1["inline-field-control"], children: control2 }),
      /* @__PURE__ */ jsx("div", { className: styles$1["inline-field-body"], children })
    ] });
  }
);
const Label = forwardRef(function Label2({ children, ...props }, ref) {
  const classes = classNames(styles$1.label, props.className);
  return /* @__PURE__ */ jsx(Label$1, { ref, ...props, className: classes, children });
});
...
const Search = ({
  ...
  return /* @__PURE__ */ jsx(Field, { name, asChild: true, children: /* @__PURE__ */ jsxs(Label, { className: classes, htmlFor: id, children: [
    /* @__PURE__ */ jsx(SvgSearch, { className: styles$9.icon, width: 20, height: 20 }),
    /* @__PURE__ */ jsx(
      "input",
      {
        id,
...
const Separator = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx($89eedd556c436f6a$export$be92b6f5f03c0fe9, { ...props, className: classes, ref });
  }
);
  ...
  function ToggleMenuItem2({ className, Icon, label: label2, onSelect, ...toggleProps }, ref) {
    ...
    return /* @__PURE__ */ jsx(
      MenuItem,
      {
        ...
        label: label2,
        onSelect,
        children: /* @__PURE__ */ jsx(ToggleInput, { id: toggleId, ref, ...toggleProps })
      }
    );
  }
);
...
export {
  ...
  ToggleMenuItem,
  Tooltip,
  ValidityState2 as ValidityState,
  getInitialLetter,
  useIdColorHash
};
//# sourceMappingURL=compound-web.js.map
